...
describe ProceduresController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.procedures.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.procedures.first.id.to_s
  ...
  it "should update procedure on put update" do
    ...
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => existing_procedure.id.to_s,
  ...
  it "should remove from @patient_data.procedures on delete destroy" do
    existing_procedure = @patient_data.procedures.first
    delete :destroy, :patient_datum_id => @patient_data.id.to_s, :id => existing_procedure.id.to_s
