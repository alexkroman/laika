...
describe InsuranceProviderPatientsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.insurance_provider_patients.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.insurance_provider_patients.first.id.to_s
  ...
  it "should update insurance_provider_patient on put update" do
    ...
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => existing_insurance_provider_patient.id.to_s,
