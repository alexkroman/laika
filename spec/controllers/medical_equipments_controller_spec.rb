...
describe MedicalEquipmentsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.medical_equipments.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.medical_equipments.first.id.to_s
  ...
  it "should update medical_equipment on put update" do
    ...
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => existing_medical_equipment.id.to_s, :medical_equipment => { :name => 'foobar'}
  ...
  it "should remove from @patient_data.medical_equipments on delete destroy" do
    existing_medical_equipment = @patient_data.medical_equipments.first
    delete :destroy, :patient_datum_id => @patient_data.id.to_s, :id => existing_medical_equipment.id.to_s
