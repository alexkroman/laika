...
describe PatientIdentifiersController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.patient_identifiers.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.patient_identifiers.first.id.to_s
  ...
  it "should update patient_identifier on put update" do
    ...
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => existing_patient_identifier.id.to_s,
  ...
  it "should remove from @patient_data.patient_identifiers on delete destroy" do
    existing_patient_identifier = @patient_data.patient_identifiers.first
    delete :destroy, :patient_datum_id => @patient_data.id.to_s, :id => existing_patient_identifier.id.to_s
