...
describe AllergiesController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient.id.to_s, :id => @patient.allergies.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient.id.to_s, :id => @patient.allergies.first.id.to_s
  ...
  it "should update allergy on put update" do
    ...
    put :update, :patient_datum_id => @patient.id.to_s, :id => existing_allergy.id.to_s,
  ...
  it "should render no_known_allergies_link partial on delete destroy" do
    delete :destroy, :patient_datum_id => @patient.id.to_s, :id => @patient.allergies.first.id.to_s
  ...
  it "should remove from @patient.allergies on delete destroy" do
    existing_allergy = @patient.allergies.first
    delete :destroy, :patient_datum_id => @patient.id.to_s, :id => existing_allergy.id.to_s
