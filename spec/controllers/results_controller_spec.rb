...
describe ResultsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.all_results.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.all_results.first.id.to_s
  ...
  it "should update result on put update" do
    ...
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => existing_result.id.to_s,
  ...
  it "should remove from @patient_data.all_results on delete destroy" do
    existing_result = @patient_data.all_results.first
    delete :destroy, :patient_datum_id => @patient_data.id.to_s, :id => existing_result.id.to_s
