...
describe MedicationsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.medications.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => @patient_data.medications.first.id.to_s
  ...
  it "should update medication on put update" do
    ...
    put :update, :patient_datum_id => @patient_data.id.to_s, :id => existing_medication.id.to_s,
  ...
  it "should remove from @patient_data.medications on delete destroy" do
    existing_medication = @patient_data.medications.first
    delete :destroy, :patient_datum_id => @patient_data.id.to_s, :id => existing_medication.id.to_s
