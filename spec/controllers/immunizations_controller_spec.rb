...
describe ImmunizationsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient.id.to_s, :id => @patient.immunizations.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient.id.to_s, :id => @patient.immunizations.first.id.to_s
  ...
  it "should update immunization on put update" do
    ...
    put :update, :patient_datum_id => @patient.id.to_s, :id => existing_immunization.id.to_s,
  ...
  it "should remove from @patient.immunizations on delete destroy" do
    existing_immunization = @patient.immunizations.first
    delete :destroy, :patient_datum_id => @patient.id.to_s, :id => existing_immunization.id.to_s
