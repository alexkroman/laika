...
describe ImmunizationsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_data_instance_id => @patient_data.id.to_s, :id => @patient_data.immunizations.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_data_instance_id => @patient_data.id.to_s, :id => @patient_data.immunizations.first.id.to_s
  ...
  it "should update immunization on put update" do
    ...
    put :update, :patient_data_instance_id => @patient_data.id.to_s, :id => existing_immunization.id.to_s,
  ...
  it "should remove from @patient_data.immunizations on delete destroy" do
    existing_immunization = @patient_data.immunizations.first
    delete :destroy, :patient_data_instance_id => @patient_data.id.to_s, :id => existing_immunization.id.to_s
