...
describe LanguagesController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient.id.to_s, :id => @patient.languages.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient.id.to_s, :id => @patient.languages.first.id.to_s
  ...
  it "should update language on put update" do
    ...
    put :update, :patient_datum_id => @patient.id.to_s, :id => existing_language.id.to_s,
  ...
  it "should remove from @patient.languages on delete destroy" do
    existing_language = @patient.languages.first
    delete :destroy, :patient_datum_id => @patient.id.to_s, :id => existing_language.id.to_s
