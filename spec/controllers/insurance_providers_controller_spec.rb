...
describe InsuranceProvidersController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient.id.to_s, :id => @patient.insurance_providers.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient.id.to_s, :id => @patient.insurance_providers.first.id.to_s
  ...
  it "should update insurance_provider on put update" do
    ...
    put :update, :patient_datum_id => @patient.id.to_s, :id => existing_insurance_provider.id.to_s,
  ...
  it "should remove from @patient.insurance_providers on delete destroy" do
    existing_insurance_provider = @patient.insurance_providers.first
    delete :destroy, :patient_datum_id => @patient.id.to_s, :id => existing_insurance_provider.id.to_s
