...
describe EncountersController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_data_instance_id => @patient_data.id.to_s, :id => @patient_data.encounters.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_data_instance_id => @patient_data.id.to_s, :id => @patient_data.encounters.first.id.to_s
  ...
  it "should update encounter on put update" do
    ...
    put :update, :patient_data_instance_id => @patient_data.id.to_s, :id => existing_encounter.id.to_s,
  ...
  it "should remove from @patient_data.encounters on delete destroy" do
    existing_encounter = @patient_data.encounters.first
    delete :destroy, :patient_data_instance_id => @patient_data.id.to_s, :id => existing_encounter.id.to_s
