...
describe ConditionsController do
  ...
  it "should render edit template on get edit" do
    get :edit, :patient_datum_id => @patient.id.to_s, :id => @patient.conditions.first.id.to_s
  ...
  it "should render show partial on put update" do
    put :update, :patient_datum_id => @patient.id.to_s, :id => @patient.conditions.first.id.to_s
  ...
  it "should update condition on put update" do
    ...
    put :update, :patient_datum_id => @patient.id.to_s, :id => existing_condition.id.to_s, :condition => { :free_text_name => 'foobar'}
  ...
  it "should remove from @patient.conditions on delete destroy" do
    existing_condition = @patient.conditions.first
    delete :destroy, :patient_datum_id => @patient.id.to_s, :id => existing_condition.id.to_s
