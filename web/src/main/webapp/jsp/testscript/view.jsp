          ...
          <tbody>
            ...
            <tr>
              ...
              <c:forEach items="${testscript.rules}" var="rule">
                <c:if test='${rule.documentLocation.name == "Patient Name"}'>
                  <c:forEach items="${rule.boundVariables}" var="boundVariable">
                    <c:if test='${boundVariable.name == "firstName"}'>
                      <c:set var="firstName" value="${boundVariable.expectedValue}"/>
                    </c:if>
                  </c:forEach>
                </c:if>
              </c:forEach>
            ...
            <tr>
              ...
              <c:forEach items="${testscript.rules}" var="rule">
                <c:if test='${rule.documentLocation.name == "Patient Name"}'>
                  <c:forEach items="${rule.boundVariables}" var="boundVariable">
                    <c:if test='${boundVariable.name == "lastName"}'>
                      <c:set var="lastName" value="${boundVariable.expectedValue}"/>
                    </c:if>
                  </c:forEach>
                </c:if>
              </c:forEach>
