...
/**
 * Simple class used to aggregate the validation of other validators into one
 * entry point. Thought it would be somewhat benificial at first to have one
 * interface that we could use to validate different codeSystems.
 * 
 * @author bobd
 * 
 */
public class XSLTValidator
{
    ...
    private static  Map<String, Validator> systemValidators = Collections
            .synchronizedMap(new HashMap<String, Validator>());
    public static  Validator val = null;

    public static void registerSystemValidator(String systemOID,
            Validator validator)
    {
    ...
    public static boolean validateCode(String system, String code,
