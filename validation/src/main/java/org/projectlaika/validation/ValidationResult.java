...
public class ValidationResult
{
    ...
    /**
     * Boolean used to tell if the validation is successful or not Set to true
     * at first
     */
    private boolean isValid = true;

    /**
     * Validation properties that can be used by validators to convey additional
     ...
     * 
     * @param id
     *            id of the validator the results are for
     */
